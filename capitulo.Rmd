...
```{r fig.cap="Figura 2:  Quantidade de artigos científicos, segundo o ano de publicação. \\linebreak Fonte: Elaborado pelas pessoas autoras.", out.width="100%", dpi = 1200}
base %>% 
  dplyr::count(ano) %>% 
  ggplot() + 
